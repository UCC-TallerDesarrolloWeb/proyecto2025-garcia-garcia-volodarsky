  ...
  return (
    <main className="container historia">
      <header className="page-header">
        ...
        <p className="lead">
          Un recorrido por los hitos del equipo: desde los inicios hasta la
          dinastía de los 90s.
        </p>
      </header>
      ...
      <section className="timeline" aria-labelledby="titulo-cronologia">
        ...
        <article className="t-item">
          <div className="t-year">1966</div>
          <div className="t-card">
            <h3>Fundación del equipo</h3>
            <p>Nacen los Chicago Bulls y debutan oficialmente en la NBA.</p>
          </div>
        </article>
        <article className="t-item">
          <div className="t-year">1984</div>
          <div className="t-card">
            <h3>Llegada de Michael Jordan</h3>
            <p>Un draft histórico que cambia el destino de la franquicia.</p>
          </div>
        </article>
        <article className="t-item">
          <div className="t-year">1991–1993</div>
          <div className="t-card">
            <h3>Primer three-peat</h3>
            <p>
              Tres campeonatos consecutivos bajo el liderazgo de MJ, Pippen y
              Phil Jackson.
            </p>
          </div>
        </article>
        <article className="t-item">
          <div className="t-year">1996–1998</div>
          <div className="t-card">
            <h3>Segundo three-peat</h3>
            <p>
              Regreso triunfal de MJ y consolidación de una dinastía
              irrepetible.
            </p>
          </div>
        </article>
        <article className="t-item">
          <div className="t-year">Siglo XXI</div>
          <div className="t-card">
            <h3>Nuevas etapas</h3>
            <p>
              Renovaciones, jóvenes talentos y momentos memorables para nuevas
              generaciones.
            </p>
          </div>
        </article>
      ...
      <section className="figuras" aria-labelledby="titulo-figuras">
        ...
        <div className="figuras-grid">
          <figure className="fig-card">
            <img src={jordanImg} alt="Michael Jordan levantando un trofeo" />
            <figcaption>
              <h3>Michael Jordan</h3>
              <p>MVP múltiples veces y emblema de la franquicia.</p>
            </figcaption>
          </figure>
          <figure className="fig-card">
            <img src={pippenImg} alt="Scottie Pippen, el escudero de Jordan" />
            <figcaption>
              <h3>Scottie Pippen</h3>
              <p>Versatilidad, defensa de élite y cerebro del equipo.</p>
            </figcaption>
          </figure>
          <figure className="fig-card">
            <img src={rodmanImg} alt="Dennis Rodman capturando un rebote" />
            <figcaption>
              <h3>Dennis Rodman</h3>
              <p>
                Trabajo sucio, dominio absoluto del rebote y energía inagotable.
              </p>
            </figcaption>
          </figure>
        </div>
      ...
      <section className="quote" aria-labelledby="titulo-cita">
        <h2 id="titulo-cita" className="visually-hidden">
          Cita destacada
        </h2>
        <blockquote>
          <p>
      ...
      <section className="faq" aria-labelledby="titulo-faq">
        ...
        <details className="faq-item">
          ...
          <p>
            En 1966. Fueron el tercer equipo de la ciudad de Chicago en la NBA.
          </p>
        </details>
        ...
        <details className="faq-item">
          ...
          <p>
            Michael Jordan, Scottie Pippen, Dennis Rodman, con Phil Jackson como
            entrenador.
          </p>
        </details>
      </section>
